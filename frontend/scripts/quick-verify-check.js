...
async function main() {
  ...
  const publicClient = createPublicClient({
    chain: sepolia,
    transport: http('https://ethereum-sepolia.publicnode.com', { timeout: 120000 }),
  });
  ...
  console.log('On-chain verify: ' + (onchainResult ? 'PASS' : 'FAIL'));
  console.log('RESULT:' + (onchainResult ? 'PASS' : 'FAIL'));
}
